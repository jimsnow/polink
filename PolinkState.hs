...
data Perm = BasicAccess | Read | AddComment | DelComment | AddLink | EditLink | DelLink | AddEntity | EditEntity | DelEntity | AddTag | DelTag | SetPerm | Admin deriving (Eq, Ord, Show, Enum)
